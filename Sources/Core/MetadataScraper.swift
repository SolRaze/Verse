...
struct MetadataScraper {
    ...
    /// TODO(later): first hit wins; wrong-artist collisions are the user's cue to rename tags.
    ...
    /// TODO(later): JSONSerialization dictionary-walk, not a Codable model — one shape, one caller.
